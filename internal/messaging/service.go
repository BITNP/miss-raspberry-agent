// Service accepts externally submitted messages and enqueues them for the main
// agent to handle. It owns the domain rules (supported platforms, required fields)
// so HTTP handlers only deal with transport concerns.
package messaging
...
func NewService(queue *todo.Store) *Service {
